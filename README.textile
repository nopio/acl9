...
Acl9 is hosted "on the GitHub":http://github.com/nopio/acl9.

You may find tutorials and additional docs on the "wiki page":http://wiki.github.com/nopio/acl9.
...
Acl9 can be installed by adding this line to your Gemfile:

gem 'acl9', :git => 'git://github.com/nopio/acl9.git'

Alternatively you can install Acl9 as a plugin:

<pre><code>
  script/plugin install git://github.com/nopio/acl9.git
</pre></code>
...
h2. Join model "roles_users"

Place @acts_as_authorization_join@ call inside of the model.
